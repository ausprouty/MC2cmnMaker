...
<div class="block ltr">
                        <div class="chapter_number ltr"><h1>6.2.</h1></div>
                        <div class="chapter_title ltr"><h1>个案#2</h1></div>
                    </div>
<div id="showVideoOptions"></div>
  <p><img alt="个案#2" src="@/assets/sites/mc2/content/M2/cmn/tot2/scenario2_cmn.jpg" style="height:558px; width:520px" /><br />
<br />
<br />
&nbsp;</p>
